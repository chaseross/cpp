...
\vspace{2mm}
\begin{itemize}[label={--}]
\item \textbf{10/3/08}: President Bush signs Emergency Economic Stabilization Act of 2008. 
\item \textbf{10/13/08}: Treasury announces standardized program to purchase equity in financial institutions. 
\item \textbf{10/14/08}: Treasury announces CPP and 9 financial institutions subscribe to the program for \$125 billion in aggregate.
\item \textbf{11/14/08}:  Deadline for publicly held financial institutions to apply to CPP.
\item \textbf{12/09/08}: To date, Treasury invests \$205 billion in 707 financial institutions.
\item \textbf{12/31/09}: Last day for Treasury to make CPP investments. 
 \end{itemize}
...
\item 17 remain 
\end{itemize}
\item The largest firms repaid preferred investment by June and purchased warrants in August 2009.
...
\begin{itemize}[label={--}]
\item Which banks participated in the CPP? The banks that needed the capital the most received funding, but strongest banks opted out $\rightarrow$ adverse signalling appeared to be minimized.
\item Bayazitova (2012) finds Treasury was most likely to accept applications from larger banks with greater systemic risks, and Treasury did not provide capital to banks with high levels of troubled assets. 
...
\item CPP may have prolonged banking recovery; CPP preferred was only buffered by common equity, not until SCAP certified TCE as adequate did bank valuations rebound. 
 \end{itemize}
